...
<li><a href="docs/07-Prova de Conceito da Arquitetura (POC) / Programação de Funcionalidades.md"> Prova de Conceito da Arquitetura (POC) e Programação de Funcionalidades</a></li>
